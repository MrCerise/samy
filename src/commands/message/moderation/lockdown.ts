...
async function runLockdown(
  ...
  if (!message.guild) {
    await message.reply({
      ...
      components: [
        new Container().text(
          Text(client.i18n.t("commands.lockdown.guild_only")),
        ),
      ],
    });
          ...
          async execute(client, message, args) {
            ...
            try {
              ...
              await message.reply({
                ...
                components: [
                  new Container().text(
                    Text(client.i18n.t("commands.lockdown.channel.add.failed")),
                  ),
                ],
              });
            }
        ...
        new MessageSubcommand({
          ...
          async execute(client, message) {
            ...
            try {
              ...
              if (channels.length === 0) {
                container.text(
                  Text(client.i18n.t("commands.lockdown.channel.list.none")),
                );
              } else {
                const lines: string[] = [];
            ...
            try {
              ...
              await message.reply({
                ...
                components: [
                  new Container().text(
                    Text(
                      client.i18n.t("commands.lockdown.channel.remove.failed"),
                    ),
                  ),
                ],
              });
          ...
          async execute(client, message, args) {
            ...
            try {
              ...
              await message.reply({
                ...
                components: [
                  new Container().text(
                    Text(client.i18n.t("commands.lockdown.role.add.failed")),
                  ),
                ],
              });
            }
        ...
        new MessageSubcommand({
          ...
          async execute(client, message) {
            ...
            try {
              ...
              if (roles.length === 0) {
                container.text(
                  Text(client.i18n.t("commands.lockdown.role.list.none")),
                );
              } else {
                const lines: string[] = [];
              ...
              await message.reply({
                ...
                components: [
                  new Container().text(
                    Text(
                      client.i18n.t("commands.lockdown.role.list.fetch_error"),
                    ),
                  ),
                ],
              });
          ...
          async execute(client, message, args) {
            ...
            try {
              ...
              await message.reply({
                ...
                components: [
                  new Container().text(
                    Text(client.i18n.t("commands.lockdown.role.remove.failed")),
                  ),
                ],
              });
            }
